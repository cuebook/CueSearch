...
export default function Connection() {
  ...
  const [isAddConnectionDrawerVisible, setIsAddConnectionDrawerVisible] =
    useState("");
  const [isViewConnectionDrawerVisible, setIsViewConnectionDrawerVisible] =
    useState("");
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (connectionType) => (
        <>
          <div
            className={style.connectionLogoTable}
            style={{
