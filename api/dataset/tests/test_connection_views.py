...
def test_connections(client, mocker):
    ...
    ConnectionParam = mixer.blend(
        "dataset.ConnectionParam", connectionType=connectionType, name="file"
    )
